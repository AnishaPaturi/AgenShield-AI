...
from reportlab.platypus import (
    BaseDocTemplate, PageTemplate, Frame, Paragraph, Spacer, Table, TableStyle, FrameBreak, PageBreak, KeepTogether, NextPageTemplate
)
...
print("expand_to_12pages scaffold ready.")
