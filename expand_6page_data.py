"""
expand_6page_data.py
Creates the optimal ~4,200-word dataset in paper_data_6pages.py for an exact 6.0-page IEEE publication.
"""
...
with open("paper_data_6pages.py", "w", encoding="utf-8") as f:
    f.write(content.strip())
print("paper_data_6pages.py updated successfully.")
